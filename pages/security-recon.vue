      ...
      <v-row class="mb-4">
        <v-col cols="12" lg="8" class="py-0">
          <p class="text-h2 mb-6">
            ...
            for information gathering, reconnaissance and software
            idenification. Wappalyzer is integrated with industry leading
            security assessment tools like OWASP ZAP.
          </p>
        </v-col>
      </v-row>
...
<script>
import { mdiConsoleLine, mdiLayers, mdiNumeric, mdiPuzzle } from '@mdi/js'
